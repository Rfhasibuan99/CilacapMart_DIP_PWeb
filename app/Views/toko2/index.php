...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top main-nav">
    <div class="container-fluid px-4">
        ...
        <form action="<?= site_url('/toko2'); ?>" method="get">
                ...
                <div class="row">
                    <?php if (in_groups('admin')): ?>
                        <div class="col text-end">
                            <a href="/toko2/tambah" class="btn btn-primary">Tambah Barang</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="d-flex gap-3 mt-4">
                                    <?php if (in_groups('admin')): ?>
                                        <a href="/toko2/ubah/<?= $a['id_barang']; ?>" class="btn btn-warning px-4">
                                            Ubah
                                        </a>
                                        <a href="/toko2/hapus/<?= $a['id_barang']; ?>" class="btn btn-danger px-4">
                                            Hapus
                                        </a>
                                    <?php endif; ?>
                                    <a href="/toko2/pesan/<?= $a['id_barang']; ?>" class="btn btn-primary px-4">
                                        Pesan
                                    </a>
                                    ...
                                    <form action="/keranjang/tambah" method="post" class="d-inline">
                                        ...
                                        <input type="hidden" name="toko" value="2"> <!-- angka sesuai toko -->
