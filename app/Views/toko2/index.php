        ...
        <div class="col text-end">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                     <a href="/toko2/ubah/<?= $a['id_barang']; ?>" class="btn btn-warning">Ubah</a>
                     <a href="/toko2/hapus/<?= $a['id_barang']; ?>" class="btn btn-danger">Hapus</a>
                     <a href="/toko2 <?= $a['id_barang']; ?>" class="btn btn-primary">Pesan</a>
                    </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
