...
<div class="container">
    <div class="col">
        ...
        <form action="/toko2/update/<?= $toko2['id_barang']; ?>" method="post" enctype="multipart/form-data" class="mt-4">
            <?= csrf_field(); ?>

            <input type="hidden" name="id_barang" value="<?= $toko2['id_barang']; ?>">
            <input type="hidden" name="gambarLama" value="<?= $toko2['gambar']; ?>">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-4">
                    <input 
                        ...
                        id="nama_barang" 
                        name="nama_barang" 
                        value="<?= old('nama_barang') ?: $toko2['nama_barang']; ?>"
                        autofocus>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-4">
                    <input 
                        ...
                        id="jenis_barang" 
                        name="jenis_barang" 
                        value="<?= old('jenis_barang') ?: $toko2['jenis_barang']; ?>">
                    <div class="invalid-feedback">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-4">
                    <input 
                        ...
                        id="harga_barang" 
                        name="harga_barang" 
                        value="<?= old('harga_barang') ?: $toko2['harga_barang']; ?>">
                    <div class="invalid-feedback">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-4">
                    <textarea 
                        ...
                        id="deskripsi" 
                        name="deskripsi"><?= old('deskripsi') ?: $toko2['deskripsi']; ?></textarea>
                    <div class="invalid-feedback">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-2">
                    <img src="/img/<?= $toko2['gambar']; ?>" class="img-thumbnail img-preview" style="width: 120px;">
                </div>
