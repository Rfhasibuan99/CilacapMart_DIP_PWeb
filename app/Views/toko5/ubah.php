...
<div class="container">
    <div class="col">
        ...
        <form action="/toko5/update/<?= $toko5['id_barang']; ?>" method="post" enctype="multipart/form-data" class="mt-4">
            <?= csrf_field(); ?>

            <input type="hidden" name="id_barang" value="<?= $toko5['id_barang']; ?>">
            <input type="hidden" name="gambarLama" value="<?= $toko5['gambar']; ?>">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-4">
                    <input 
                        ...
                        id="nama_barang" 
                        name="nama_barang" 
                        value="<?= old('nama_barang') ?: $toko5['nama_barang']; ?>"
                        autofocus>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-4">
                    <input 
                        ...
                        id="jenis_barang" 
                        name="jenis_barang" 
                        value="<?= old('jenis_barang') ?: $toko5['jenis_barang']; ?>">
                    <div class="invalid-feedback">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-4">
                    <textarea 
                        ...
                        id="deskripsi" 
                        name="deskripsi"><?= old('deskripsi') ?: $toko5['deskripsi']; ?></textarea>
                    <div class="invalid-feedback">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-2">
                    <img src="/img/<?= $toko5['gambar']; ?>" class="img-thumbnail img-preview" style="width: 120px;">
                </div>
