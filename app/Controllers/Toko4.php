...
class Toko4 extends BaseController
{
    ...
    public function ubah($idbarang)
    {
        $data = [
            ...
            'validation' => \Config\Services::validation(),
            'toko4' => $this->Toko4Model->getBarang($idbarang)
        ];

        return view('toko4/ubah', $data);
    }
    ...
    {
        $dataLama = $this->Toko4Model->getBarang($idbarang);
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/toko4/ubah/' . $idbarang)->withInput();
        }
    ...
    {
        $barang = $this->Toko4Model->getBarang($idbarang);
        ...
        $this->Toko4Model->delete($idbarang);
