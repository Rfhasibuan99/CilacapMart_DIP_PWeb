...
class Toko2 extends BaseController
{
    ...
    public function update($idbarang)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/toko2/ubah/' . $idbarang)->withInput();
        }
    ...
    public function hapus($idbarang)
    {
        ...
        $this->toko2Model->delete($idbarang);
